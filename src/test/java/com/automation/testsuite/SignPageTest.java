...
import resources.testdata.TestData;
    ...
    public class SignPageTest extends TestBase {
        ...
        @org.testng.annotations.Test(groups = {"sanity", "regression"})
       ...
       @org.testng.annotations.Test(dataProvider = "credentials", dataProviderClass=TestData.class,groups = {"regression"})
